...
const caseStudies: CaseStudy[] = [
  ...
  { id: 35, title: "Educational Content Delivery App (EdTech)", client: "Global Language School", industry: "Education Technology", previewResult: "Achieved 4.8/5.0 average user rating in both app stores", previewMetric: "4.8/5.0 Rating", image: "https://images.pexels.com/photos/32396969/pexels-photo-32396969.jpeg", challenge: "Client needed a highly engaging, offline-capable mobile app to deliver their premium course content worldwide.", solution: "Built a robust content management system API and a cross-platform app optimized for offline data synchronization...", results: "The app's seamless performance and reliability led to overwhelmingly positive user reviews...", tags: ["Mobile App Dev", "EdTech", "Offline Sync", "Content Delivery"], category: 'App Development', },
